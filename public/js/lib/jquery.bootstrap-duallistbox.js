    ...
    $.fn.bootstrapDualListbox = function(options) {
        ...
        return this.each(function() {
            ...
            if ($this.data('duallistbox_generated')) {
                ...
                $this.data('duallistbox_generated', true);
            }
